...
crds_to_patch := installer.voyagermesh.com_voyageroperators.yaml
...
gen-crd-protos-%:
	...
	@docker run --rm                                     \
		...
		go-to-protobuf                                   \
			...
			--packages=-k8s.io/api/core/v1,voyagermesh.dev/installer/apis/$(subst _,/,$*)
...
gen-values-schema:
	@yq r api/crds/installer.voyagermesh.com_voyageroperators.yaml spec.validation.openAPIV3Schema.properties.spec > /tmp/voyager-values.openapiv3_schema.yaml
