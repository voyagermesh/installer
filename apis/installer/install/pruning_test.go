...
import (
	...
	"voyagermesh.dev/installer/apis/installer/fuzzer"
...
func TestPruneTypes(t *testing.T) {
	...
	// CRD v1
	if crd := (v1alpha1.VoyagerOperator{}).CustomResourceDefinition(); crd.V1 != nil {
		crdfuzz.SchemaFuzzTestForV1CRD(t, clientsetscheme.Scheme, crd.V1, fuzzer.Funcs)
	}

	// CRD V1beta1
	if crd := (v1alpha1.VoyagerOperator{}).CustomResourceDefinition(); crd.V1beta1 != nil {
