...
$ helm repo update
$ helm search repo appscode/voyager-crds --version=v2025.5.30
$ helm upgrade -i voyager-crds appscode/voyager-crds -n voyager --create-namespace --version=v2025.5.30
```
