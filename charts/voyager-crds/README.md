...
$ helm repo update
$ helm search repo appscode/voyager-crds --version=v2024.9.30
$ helm upgrade -i voyager-crds appscode/voyager-crds -n voyager --create-namespace --version=v2024.9.30
```
