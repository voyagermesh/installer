...
$ helm repo update
$ helm search repo appscode/voyager-crds --version=v2026.3.23
$ helm upgrade -i voyager-crds appscode/voyager-crds -n voyager --create-namespace --version=v2026.3.23
```
