...
Common labels
*/}}
{{- define "crd-manager.labels" -}}
kubeslice.io/exclude: "true"
helm.sh/chart: {{ include "crd-manager.chart" . }}
{{ include "crd-manager.selectorLabels" . }}
{{- if .Chart.AppVersion }}
...
Selector labels
*/}}
{{- define "crd-manager.selectorLabels" -}}
app.kubernetes.io/name: {{ include "crd-manager.name" . }}
...
*/}}
{{- define "crd-manager.serviceAccountName" -}}
{{- if .Values.serviceAccount.create }}
{{- default (include "crd-manager.fullname" .) .Values.serviceAccount.name }}
{{- else }}
...
{{- printf "%s-license" (include "crd-manager.fullname" .) -}}
{{- end }}
{{- end }}
